				...
				<s:form id="myForm" action="InscriptionPatient" theme="bootstrap"
					...
					<fieldset>
						...
						<s:select
							...
							headerKey="None" headerValue="None" label="Civilité"
  ...
  <div id="java">
   java                             
						...
						<s:textfield label="Prénom du père" name="prenomPere"
							cssClass="col-lg-11" placeholder="Prénom du père" />
						<s:textfield label="Nom de mère" name="nomMere"
							cssClass="col-lg-11" placeholder="Nom de mère" />

						<s:textfield label="Prénom de mère" name="prenomMere"
							cssClass="col-lg-11" placeholder="Prénom de mère" />
						<s:textfield label="Nom d'époux(se)" name="prenomEpoux"
							cssClass="col-lg-11" placeholder="Nom d'époux(se)" />
						<table>
							<tr>
						...
						<s:select
							...
							label="Nationalité" name="nationalite" cssClass="col-lg-11"
					...
					<fieldset>
						...
						<s:textfield maxLength="8" size="8" name="telephonePortable"
							label="Numéro de téléphone" cssClass="col-lg-11"
