...
<head>
	<meta charset="UTF-8">
	<title>Patient Login success - LHCS</title>
...
<body>
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			<h1 class="panel-title" align="center">Patient Login success</h1>
		</div>
	...
	<a class="btn btn-primary" href="login-input">Login as different
		user?</a>
		<a class="btn btn-primary" href="ProfilePatient">your profile
		</a>
		</div>
</body>
</html>