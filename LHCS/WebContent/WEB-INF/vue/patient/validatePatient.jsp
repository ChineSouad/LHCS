...
<body>
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			<h3 class="panel-title" align="center">Un mail de validation est envoyé à <s:property value="#session.mail"/>. Veuillez confirmer votre inscription en saisissant le code reçu.</h3>
		</div>
		<div class="panel-body">
			...
			<s:form id="myForm" action="ConfirmPatient" theme="bootstrap"
